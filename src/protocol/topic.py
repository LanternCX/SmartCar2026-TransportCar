...
TOPIC_VISION_BOOT_READY = const(0x14)
TOPIC_VISION_BOOT_CONFIRM = const(0x15)
...
_TOPIC_TABLE = (
    ...
    (TOPIC_MASTER_VISION_EVENT_REPORT, MODE_TCP, _PORT_UART6, 4, _ROLE_MASTER_MASK, 0),
    (
    ...
    (TOPIC_VISION_BOOT_READY, MODE_TCP, _PORT_UART6, 0, _ROLE_BOTH_MASK, 0),
    (TOPIC_VISION_BOOT_CONFIRM, MODE_TCP, _PORT_UART6, 0, 0, _ROLE_BOTH_MASK),
    (TOPIC_ASSISTANT_STATE_SYNC, MODE_TCP, _PORT_UART8, 4, _ROLE_ASSISTANT_MASK, _ROLE_MASTER_MASK),
