...
# 辅车子状态编号
ASSISTANT_STATE_IDLE = const(0)
ASSISTANT_STATE_FOLLOW = const(1)
ASSISTANT_STATE_APPROACH_OBJECT = const(2)
ASSISTANT_STATE_ORBIT = const(3)
ASSISTANT_STATE_TRANSPORT_OBJECT = const(4)
ASSISTANT_STATE_CLEAR_OBJECT = const(5)
ASSISTANT_STATE_RETURN_FOLLOW = const(6)
ASSISTANT_STATE_FINISHED = const(7)
ASSISTANT_STATE_STARTUP_MOVE = const(8)
_STATE_NAMES = (
    "IDLE",
    "FOLLOW",
    "APPROACH_OBJECT",
...
# 辅车目标编号
ASSISTANT_TARGET_NONE = const(0)
ASSISTANT_TARGET_OBJECT = const(1)
