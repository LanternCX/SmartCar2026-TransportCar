...
- 协作文档放在 `docs/superpowers/`：`specs/` 负责设计，`plans/` 负责执行，`reference/` 放对照表，`memory/` 放可复用结论
- 新文档优先放入 `developer/`、`problem_statement/`、`superpowers/`，新增主入口或一级目录后同步更新本页
- 文档统一使用中文，只写当前事实；先更新正文，再更新索引
