...
| 2026-03-25-1 | 2026-03-25 | 冻结 legacy 并建立 master-assistant 最小运行时主线 | `docs/superpowers/memory/refactor/entries/2026-03/2026-03-25-1.md` | 将旧运行时代码冻结归档到 `src/legacy`，建立 `master` / `assistant` 最小运行时与主辅协议主线，并把主机侧验证面收敛到新系统。 | legacy, master, assistant, protocol, archive, runtime, tests |
